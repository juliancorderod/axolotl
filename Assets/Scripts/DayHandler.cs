...
public class DayHandler : MonoBehaviour {
	...
	public class SceneObj {
		...
		public SceneObj(GameObject goref, string id, float xthresh, Vector3 pos, bool ag) { // constructor
			oID = id;
			oXThresh = xthresh;
			oPos = pos;
			oRef = goref;
	...
	void Start () {
		...
		if (sceneObject_1 != null)
			sceneObjs.Add(new SceneObj(sceneObject_1, "1", sceneObjThresh_1, sceneObject_1.transform.position, atGlass_1));
		if (sceneObject_2 != null)
			sceneObjs.Add(new SceneObj(sceneObject_2, "2", sceneObjThresh_2, sceneObject_2.transform.position, atGlass_2));
		if (sceneObject_3 != null)
			sceneObjs.Add(new SceneObj(sceneObject_3, "3", sceneObjThresh_3, sceneObject_3.transform.position, atGlass_3));
		if (sceneObject_4 != null)
			sceneObjs.Add(new SceneObj(sceneObject_4, "4", sceneObjThresh_4, sceneObject_4.transform.position, atGlass_4));
		if (sceneObject_5 != null)
			sceneObjs.Add(new SceneObj(sceneObject_5, "5", sceneObjThresh_5, sceneObject_5.transform.position, atGlass_5));
	}
